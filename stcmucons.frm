VERSION 5.00
Begin VB.Form frmStaMultiConsignment 
   Caption         =   "Add values"
   ClientHeight    =   7815
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin VB.Frame fraLists 
      ...
      Begin VB.ListBox lstCode 
         Height          =   1815
         Index           =   1
         ItemData        =   "stcmucons.frx":0000
         Left            =   120
         List            =   "stcmucons.frx":0007
         TabIndex        =   18
         Top             =   600
         Width           =   1455
      End
   ...
   Begin VB.Frame fraLists 
      ...
      Begin VB.ListBox lstCode 
         Height          =   1815
         Index           =   0
         ItemData        =   "stcmucons.frx":0017
         Left            =   120
         List            =   "stcmucons.frx":001E
         TabIndex        =   6
         Top             =   600
         Width           =   1455
      End
   ...
   End
End
Attribute VB_Name = "frmStaMultiConsignment"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Const lintStartIndex = 6
Const lintEndIndex = 7
